...
class LinearEvaluation(LightningModule):
    def __init__(self, args, encoder: nn.Module, hidden_dim: int, output_dim: int):
        ...
        self.accuracy = torchmetrics.Accuracy(task='multilabel', num_labels=encoder.num_classes)
        self.average_precision = torchmetrics.AveragePrecision(task='multilabel', num_labels=encoder.num_classes)
